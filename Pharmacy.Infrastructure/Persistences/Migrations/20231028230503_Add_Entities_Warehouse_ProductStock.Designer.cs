...
namespace Pharmacy.Infrastructure.Persistences.Migrations
{
    ...
    [Migration("20231028230503_Add_Entities_Warehouse_ProductStock")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.BranchOffice", b =>
                {
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Business", b =>
                {
                    b.Property<int>("BusinessId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Department", b =>
                {
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.District", b =>
                {
                    b.Property<int>("DistrictId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.DocumentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Menu", b =>
                {
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.MenuRole", b =>
                {
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.ProductStock", b =>
                {
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Provider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Province", b =>
                {
                    b.Property<int>("ProvinceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Purcharse", b =>
                {
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.PurcharseDetail", b =>
                {
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.SaleDetail", b =>
                {
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.UserRole", b =>
                {
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.UsersBranchOffice", b =>
                {
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Warehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.BranchOffice", b =>
                {
                    b.HasOne("Pharmacy.Domain.Entities.Business", "Business")
                        .WithMany("BranchOffices")
                        .HasForeignKey("BusinessId")
                        .IsRequired()
                        .HasConstraintName("FK__BranchOff__Busin__48CFD27E");

                    b.HasOne("Pharmacy.Domain.Entities.District", "District")
                        .WithMany("BranchOffices")
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Client", b =>
                {
                    b.HasOne("Pharmacy.Domain.Entities.DocumentType", "DocumentType")
                        .WithMany("Clients")
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.District", b =>
                {
                    b.HasOne("Pharmacy.Domain.Entities.Province", "Province")
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.MenuRole", b =>
                {
                    b.HasOne("Pharmacy.Domain.Entities.Menu", "Menu")
                        .WithMany("MenuRoles")
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("Pharmacy.Domain.Entities.Provider", null)
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.ProductStock", b =>
                {
                    ...
                    b.HasOne("Pharmacy.Domain.Entities.Warehouse", "Warehouse")
                        .WithMany("ProductStocks")
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Province", b =>
                {
                    b.HasOne("Pharmacy.Domain.Entities.Department", "Department")
                        .WithMany("Provinces")
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Purcharse", b =>
                {
                    b.HasOne("Pharmacy.Domain.Entities.Provider", "Provider")
                        .WithMany("Purcharses")
                        .HasForeignKey("ProviderId")
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.PurcharseDetail", b =>
                {
                    ...
                    b.HasOne("Pharmacy.Domain.Entities.Purcharse", "Purcharse")
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.UserRole", b =>
                {
                    b.HasOne("Pharmacy.Domain.Entities.BranchOffice", "BranchOffice")
                        .WithMany("UserRoles")
